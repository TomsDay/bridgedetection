...
public class EmoticonUtil {
	...
	public static void initEmoji() {
		...
		/*String[] stringArray = BridgeDetectionApplication.getInstance()
		...
		for(Emojicon emojicon:data) {
			if(emojicon.getEmoji() != null) {
				...
				if(unicode > 0xff) {
					emoji.setId(EmojiconHandler.getEmojiResource(BridgeDetectionApplication.getInstance().getApplicationContext(), unicode));
					emojis.add(emoji);
				}
			}
		}
