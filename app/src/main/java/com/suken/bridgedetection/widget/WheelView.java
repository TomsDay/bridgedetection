...
public class WheelView extends View {
	...
	private static final int ADDITIONAL_ITEM_HEIGHT = (int) (15 * UiUtil.DP);

	/** Text size */
	private static final int TEXT_SIZE = (int) (16 * UiUtil.DP);

	/** Top and bottom items offset (to hide that) */
	private static final int ITEM_OFFSET = TEXT_SIZE / 5;

	/** Additional width for items layout */
	private static final int ADDITIONAL_ITEMS_SPACE = (int) (10 * UiUtil.DP);

	/** Label offset */
	private static final int LABEL_OFFSET = (int) (8 * UiUtil.DP);

	/** Left and right padding value */
	private static final int PADDING = (int) (10 * UiUtil.DP);
