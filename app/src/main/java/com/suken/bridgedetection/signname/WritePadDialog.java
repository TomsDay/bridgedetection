package com.suken.bridgedetection.signname;
...
public class WritePadDialog extends Dialog {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int screenWidth = (int) (450 * mDisplayMetrics.density);
        int screenHeight = (int) (300 * mDisplayMetrics.density);
        mPaintView = new PaintView(mContext, screenHeight, screenWidth);
